...
docker pull upendraj1/new-api-gateway:latest
docker pull upendraj1/new-product-service:latest
docker pull upendraj1/new-order-service:latest
docker pull upendraj1/new-inventory-service:latest
docker pull upendraj1/new-notification-service:latest
...
kind load docker-image -n microservices upendraj1/new-api-gateway:latest
kind load docker-image -n microservices upendraj1/new-product-service:latest
kind load docker-image -n microservices upendraj1/new-order-service:latest
kind load docker-image -n microservices upendraj1/new-inventory-service:latest
kind load docker-image -n microservices upendraj1/new-notification-service:latest
